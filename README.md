...
📊 O QUE O PROJETO FAZ?
Para Investidores
Gerencia portfólios - Adiciona/remove ações facilmente
Analisa performance - Retorno, risco, Sharpe Ratio
Otimiza alocação - Encontra a melhor distribuição
Visualiza dados - Dashboards interativos
Monitora em tempo real - Preços atualizados
Para Desenvolvedores
API REST - Integre com outros sistemas
Testes automatizados - CI/CD configurado
Código reutilizável - Classes bem estruturadas
Documentação completa - Fácil de entender
Exemplos práticos - Aprenda fazendo
📁 ARQUIVOS PRINCIPAIS
portfolio-analyzer/
